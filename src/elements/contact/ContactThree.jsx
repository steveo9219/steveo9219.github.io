						...
						<div className="col-lg-6 order-2 order-lg-1">
							<div className="section-title text-left mb--50">
								...
								<p className="description">
									Contact me with any more questions you have! I would love to
									be part of your team. Connect with me via phone:{" "}
									<a href="tel:+15129702615">512-970-2615</a> or email:
									<a href="mailto:stephen.guzman92@gmail.com">
										{" "}
										stephen.guzman92@gmail.com
									</a>{" "}
								</p>
							</div>
